...
S1, S2, ¡¦, SN. In a single operation, you can choose two indices L and R such 
that 1 ¡Â L ¡Â R ¡Â N and flip the characters SL, SL+1, ¡¦, SR. By flipping, 
...
vector<int> Flip(string A) {
	...
	if (max_sum == INT_MIN) return vector<int>();
